...
(defn record->hl7
  ...
  (message/record-to-hl7
   ...
   #(vector
     ...
     (parser/create-field (util/trim-nils (segment/ts->field (:patient-death-date-time %))))
     ...
     (parser/create-field (util/trim-nils (segment/ts->field (:last-update-date-time %))))
     (parser/create-field (util/trim-nils (segment/hd->field (:last-update-facility %))))
